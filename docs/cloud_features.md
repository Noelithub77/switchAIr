...
This document explains the cloud AI account management and switching capabilities in switchAir. The feature allows users to manage multiple Google accounts, monitor API quotas, and seamlessly switch the active IDE account with one click.
