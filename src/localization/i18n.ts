    ...
    resources: {
      en: {
        translation: {
          ...
          accountSources: {
            description: 'Switch between Antigravity and OpenCode account management.',
            antigravity: {
              tab: 'Antigravity',
              title: 'Antigravity',
              description: 'Manage Antigravity cloud accounts and import/export IDE auth state.',
              export: 'Export',
              import: 'Import',
              exportConfirm: 'Export Anyway',
              exportWarningTitle: 'Export Antigravity Auth State?',
              exportWarningDescription:
                'This export includes the full Antigravity authentication state and can be imported elsewhere.',
              exportWarningHint:
                'Treat the exported JSONC file like a secret. Anyone with it can restore this account state.',
              exportSuccessTitle: 'Antigravity export created',
              exportFailedTitle: 'Failed to export Antigravity state',
              importSuccessTitle: 'Antigravity state imported',
              importFailedTitle: 'Failed to import Antigravity state',
            },
            opencode: {
              tab: 'OpenCode',
              title: 'OpenCode',
              ...
              empty: 'No OpenCode accounts discovered yet.',
              ...
              import: 'Import',
              exportConfirm: 'Export Anyway',
              exportWarningTitle: 'Export OpenCode Accounts?',
              exportWarningDescription:
                'This export includes full provider auth tokens so it can be imported on another machine.',
              exportWarningHint:
                'Treat the exported JSONC file like a secret. It contains full auth tokens.',
              exportSuccessTitle: 'OpenCode export created',
              exportFailedTitle: 'Failed to export OpenCode accounts',
              importSuccessTitle: 'OpenCode accounts imported',
              importFailedTitle: 'Failed to import OpenCode accounts',
              activateSuccessTitle: 'OpenCode account activated',
              activateSuccessDescription: 'auth.json was updated for the selected provider slot.',
              activateFailedTitle: 'Failed to activate OpenCode account',
              removeLive: 'Remove Live Auth',
              ...
              noteSavedDescription: 'The OpenCode account note was updated.',
              noteSaveFailedTitle: 'Failed to save note',
              live: 'Live',
              accountId: 'Account ID: {{value}}',
              lastSynced: 'Last synced {{value}}',
              updated: 'Updated {{value}}',
              loadFailedTitle: 'Failed to load OpenCode accounts',
            },
          },
          account: {
            current: 'Current',
